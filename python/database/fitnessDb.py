...
Description:
    Algorithms for building the fitness database
"""
# ==============================================================================
# Dependencies
# ==============================================================================
...
# Constants / Globals
# ==============================================================================
TABLES_FILE = os.path.dirname(__file__)
TABLES_FILE = os.path.join(TABLES_FILE, "db_tables.txt")

USER_DATA = {"pkatzen@localhost": "pkatzen"}
_LOGGER = fitness.LOGGER
